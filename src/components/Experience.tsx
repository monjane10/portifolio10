  ...
  const experiences = [
    {
      ...
      points: [
        ...
        "Colaboração com equipas multidisciplinares para optimizar processos e melhorar a experiência do utilizador.",
        "Garantia da qualidade do código através de boas práticas de desenvolvimento e testes rigorosos.",
      ]
    }
  ];
